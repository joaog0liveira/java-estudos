...
public class GlobalParaLocal {
    public static void main(String[] args) {
        ...
        System.out.println("r1 = " + String.valueOf(r1));
        System.out.println("r2 = " + String.valueOf(r2));
        System.out.println("r3 = " + String.valueOf(r3));
        System.out.println("r4 = " + String.valueOf(r4));
